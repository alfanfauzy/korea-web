...
const Section3 = () => {
    return (
        <section className="flex flex-col gap-10 text-center mt-10 mb-10 w-full px-10">
            <div className="relative w-fit mx-auto my-16">
                <div className="-top-1 -left-4 absolute bg-gradient-border rounded-full h-3 w-3" />
                <h1 className="uppercase text-3xl font-bold">Making Process</h1>
            </div>
            <div className="flex desktop:flex-row flex-col gap-10">
                <div className="desktop:border desktop:border-stone-500 desktop:rounded-3xl desktop:py-20 desktop:px-10 desktop:bg-white/10">
                    <div className="flex gap-3 flex-col mb-10">
                        <h2 className="text-3xl">일반 제작</h2>
                        <h4 className=" text-2xl text-white/50">
                            제작 시작 후 5영업일 이내
                        </h4>
                    </div>
                    <div className="w-full flex flex-col gap-4 ">
                        <div className="relative desktop:rounded-full desktop:px-20 rounded-2xl text-white p-6 border border-white/15 desktop:bg-black bg-white/10 w-full mx-auto">
                            <div className="flex flex-row gap-10">
                                <div className="flex flex-col items-start">
                                    <h2 className="text-center text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E7E] to-[#F05F82] uppercase text-lg">
                                        Step1
                                    </h2>
                                ...
                                <p className="font-extralight text-2xl text-white/50 text-left basis-3/4">
                                    영상 제작 문의를 통해 의뢰 확인 후 상담을
                                    통해 방향 설정 및 내용 협의
                                </p>
                            </div>
                        ...
                        <div className="relative desktop:rounded-full desktop:px-20 rounded-2xl text-white p-6 border border-white/15 desktop:bg-black bg-white/10 w-full mx-auto">
                            <div className="flex flex-row gap-10">
                                ...
                                <p className="font-extralight text-2xl text-white/50 text-left basis-3/4">
                                    작성한 스크립트로 가상인간 영상 생성 그외
                                    이미지, 배경 음악 등 필요 요소 생성
                                </p>
                            </div>
                            <div className="absolute bottom-[-10px] left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-12 border-r-12 border-t-10 border-transparent border-t-[#444444] z-40"></div>
                        </div>
                ...
                <div className="relative p-1 desktop:rounded-3xl desktop:bg-gradient-to-r from-[#FF4E83] to-[#FFBB54] w-full">
                    <div className="rounded-3xl bg-black flex flex-col items-center justify-center desktop:px-10 h-full">
                        <div className="mb-10">
                            ...
                            <div className=" bg-black flex flex-col rounded-4xl  items-center justify-center h-full w-full">
                                <div className="w-full p-5 flex flex-row gap-10">
                                    ...
                                    <div className="text-left pt-4 basis-3/4">
                                        <h2 className="text-2xl">제작 안내</h2>
                                ...
                                <div className="w-full p-5 flex flex-row gap-10">
                                    ...
                                    <div className="text-left pt-4 basis-3/4">
                                        <h2 className="text-2xl">영상 생성</h2>
                                        <h3 className="text-xl text-white/50 border-b-2 border-b-white/15 font-light pb-10">
                                            스크립트 수신 즉시 가상인간 영상
                                            생성 그외 이미지, 배경 음악 등
                                            필요 요소 생성
            ...
            <div className="flex gap-5 flex-col">
                <h5 className="text-lg text-white/50">
                      * 2~3분, 표준 견적에 따르는 일반 영상편집에
                    한정되며, 모션그래픽 등전문 작업이 필요할 경우 작업 기간은
                    조정될 수 있습니다.
                </h5>
                <h5 className="text-lg text-white/50">
                    ** 영상의 길이, 영상 제작에 필요한 수준에 따라 빠른 작업이
                    불가할 수 있으며, 클라이언트와의 협의를 통해 작업 기간을
                    조정할 수 있습니다.
                </h5>
            </div>
        </section>
