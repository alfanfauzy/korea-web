      ...
      <div className="flex desktop:flex-row flex-col gap-10">
        <div className="desktop:border desktop:border-stone-500 desktop:rounded-3xl desktop:py-20 desktop:px-10 desktop:bg-white/10 basis-1/2">
          ...
          <div className="w-full flex flex-col gap-4 ">
            <div className="relative desktop:rounded-full desktop:p-5 rounded-2xl text-white p-6 border border-white/15 desktop:bg-black bg-white/10 w-full mx-auto">
              <div className="flex flex-row gap-10">
                <div className="flex flex-col items-start">
                  <h2 className="desktop:text-sm text-center text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E7E] to-[#F05F82] uppercase text-lg">
                    Step1
                  </h2>
                  <h3 className="desktop:text-sm text-xl font-bold">
                    사전 논의
                  </h3>
                </div>
                <p className="desktop:text-xs font-extralight text-2xl text-white/50 text-left basis-3/4">
            ...
            <div className="relative desktop:rounded-full desktop:p-5 rounded-2xl text-white p-6 border border-white/15 desktop:bg-black bg-white/10 w-full mx-auto">
              <div className="flex flex-row gap-10">
                ...
                <p className="desktop:text-sm font-extralight text-2xl text-white/50 text-left basis-3/4">
            ...
            <div className="relative p-1 rounded-4xl mobile:bg-gradient-to-r from-[#FF4E83] to-[#FFBB54] w-full">
              <div className=" bg-black flex flex-col rounded-4xl  items-center justify-center h-full w-full">
                <div className="w-full p-5 flex flex-row gap-10">
                  <div className="relative rounded-3xl bg-gradient-to-r from-[#FF4E83] to-[#FFBB54] w-28 h-24 flex flex-col items-center gap-1 p-3">
                  ...
                  <div className="text-left pt-3 basis-3/4">
